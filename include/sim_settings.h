...
template<typename T>
struct SimSettings {
  T radius_min;       ///<< radius of all particles
  T radius_max;       ///<< radius of all particles
  T mass_min;               ///<< the minimum mass a particle can have
  T mass_max;               ///<< the maximum mass a particle can have
  ...
  T gravity;                    ///<< I don't think you understand the gravity of the situation
...
//const SimSettings<double> DefaultSettings{
//  /* .radius_min */             10.f,
//  /* .radius_max */             20.f,
//  /* .mass_min */               1.f,
//  /* .mass_max */               10.f,
...
//};
//
//const SimSettings<int64_t> DefaultSettings{
//  /* .radius_min */             10,
//  /* .radius_max */             20,
//  /* .mass_min */               1,
//  /* .mass_max */               10,
